...
namespace Client
{
	...
	enum SHADER_STATE { SHADER_IDLE_ALPHATEST, SHADER_IDLE_ALPHABLEND, SHADER_HIT, SHADER_PICKING, SHADER_DEAD, SHADER_LIGHT,SHADER_DARK, SHADER_DARKWITHLIGHT, SHADER_DAYCYClE };
