...
namespace Client
{
	...
	enum WEAPON_TYPE { WEAPON_HAND, WEAPON_SWORD, WEAPON_STAFF, WEAPON_DART, WEAPON_BOMB, WEAPON_SMOKE, WEAPON_LIGHTNING, WEAPON_ICESPIKE1, WEAPON_ICESPIKE2, WEAPON_ICESPIKE3, WEAPON_ICESPIKE4, WEAPON_ICESMOKE,
		WEAPON_MINES, WEAPON_MINE, WEAPON_PUFF, WEAPON_ROCK, BEARGER_SPECIAL, BOARRIOR_SPECIAL, CARNIVAL_ARROW, WEAPON_END };
	...
	enum INTERACTOBJ_ID { TREE, GRASS, BOULDER, BERRYBUSH, ITEMS, CARROT, NPC, PORTAL, COOKPOT, TENT, SKELETON, DIRT, BATTERY, ID_END };
	enum ITEMNAME {
	...
	enum NPCID {NPC_PIGKING, NPC_WENDY, NPC_WINONA, NPC_END}; 
	...
	enum MININAME { MIN_PLAYER , MIN_FENCE, MIN_POT, MIN_TENT, MIN_ROCK , MIN_WOOD , MIN_BERRYBUSH ,MIN_CARROT,  MIN_GRASS , MIN_SPIDER , MIN_SPIDERWARRIOR , 
		MIN_BEARGER , MIN_BOARON, MIN_PIG , MIN_BOARRIOR, MIN_WENDY , MIN_PIGKING , MIN_PORTAL , MIN_BOSSPORTAL , MIN_HOUSE, MIN_HOUSE2, MIN_WINONA,  MIN_END  };
