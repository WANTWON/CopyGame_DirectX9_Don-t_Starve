...
namespace Client
{
	...
	enum INTERACTOBJ_ID { TREE, GRASS, BOULDER, BERRYBUSH, ITEMS, CARROT, NPC, PORTAL, COOKPOT, TENT, ID_END };
	enum ITEMNAME {
		...
		ITEMNAME_QUEST1 , ITEMNAME_POT , ITEMNAME_BLOCK ,ITEMNAME_FENCE, ITEMNAME_END
	};


	enum MAKEWHAT { MAKE_AXE, MAKE_PICK, MAKE_HAMBAT, MAKE_SHOTTER, MAKE_STAFF, MAKE_ARMOR, MAKE_HELMET,MAKE_FENCE,MAKE_POT, MAKE_END };
