...
namespace Client
{
	...
	enum MININAME { MIN_PLAYER , MIN_FENCE, MIN_POT, MIN_TENT, MIN_ROCK , MIN_WOOD , MIN_BERRYBUSH ,MIN_CARROT,  MIN_GRASS , MIN_SPIDER , MIN_SPIDERWARRIOR , 
		MIN_BEARGER , MIN_BOARON, MIN_PIG , MIN_BOARRIOR, MIN_WENDY , MIN_PIGKING , MIN_PORTAL , MIN_BOSSPORTAL , MIN_HOUSE, MIN_HOUSE2, MIN_WINONA,MIN_TERRORBEAK, MIN_END  };
	...
	enum SOUND_ID { SOUND_BGM, SOUND_GROUND, SOUND_UI, SOUND_UIOPEN, SOUND_UICLOSE, SOUND_MONSTER_VOICE, SOUND_MONSTER_EFFECT, SOUND_OBJECT, SOUND_PLAYER, SOUND_WENDY, SOUND_WINONA, SOUND_WOODIE, SOUND_END};
