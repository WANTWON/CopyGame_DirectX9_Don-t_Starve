...
namespace Client
{
	...
	enum WEAPON_TYPE { WEAPON_HAND, WEAPON_SWORD, WEAPON_STAFF, WEAPON_DART, WEAPON_BOMB, WEAPON_SMOKE, WEAPON_LIGHT, WEAPON_ICESPIKE1, WEAPON_ICESPIKE2, WEAPON_ICESPIKE3, WEAPON_ICESPIKE4, WEAPON_ICESMOKE,
		WEAPON_PICKAXE, WEAPON_AXE, WEAPON_MINES, WEAPON_MINE, WEAPON_PUFF, WEAPON_ROCK, BEARGER_SPECIAL, BOARRIOR_SPECIAL, BOARRIOR_FIRE, CARNIVAL_ARROW, WEAPON_END };
	enum DAMAGE_ATTRIBUTE { ATTR_BASIC, ATTR_STUN, ATTR_MAX };
	...
	enum MININAME { MIN_PLAYER , MIN_FENCE, MIN_POT, MIN_TENT, MIN_ROCK , MIN_WOOD , MIN_BERRYBUSH ,MIN_CARROT,  MIN_GRASS , MIN_SPIDER , MIN_SPIDERWARRIOR , 
		MIN_BEARGER , MIN_BOARON, MIN_PIG , MIN_BOARRIOR, MIN_WENDY , MIN_PIGKING , MIN_PORTAL , MIN_BOSSPORTAL , MIN_HOUSE, MIN_HOUSE2, MIN_WINONA,MIN_TERRORBEAK,MIN_WOODIE, MIN_END  };

	enum SHADER_STATE { SHADER_IDLE, SHADER_HIT, SHADER_PICKING, SHADER_DEAD, SHADER_FIRE,SHADER_DARK, SHADER_DARKWITHLIGHT, SHADER_DAYCYClE , SHADER_CONSTRUCT};
	enum UI_SHADER_STATE { UI_SHADER_IDLE , UI_SHADER_SCREEN , UI_SHADER_MINIMAP , UI_SHADER_HP , UI_SHADER_GREEN , UI_SHADER_CARD};
	...
	typedef struct tagDamageTypeDesc {
		DAMAGE_ATTRIBUTE eDamageType;
	}DAMAGETYPEDESC;
}
