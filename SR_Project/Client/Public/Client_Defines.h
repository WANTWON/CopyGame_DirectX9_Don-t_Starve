...
enum ITEMNAME { ITEMNAME_ARMOR, ITEMNAME_AXE, ITEMNAME_BAG, ITEMNAME_BERRY, ITEMNAME_SHOTTER, ITEMNAME_WOOD , ITEMNAME_CARROT, ITEMNAME_COAL,
	ITEMNAME_WAND, ITEMNAME_GRASS,ITEMNAME_ROCK, ITEMNAME_HELMAT, ITEMNAME_GOLD, ITEMNAME_HAMSTICK, ITEMNAME_WOOD2, ITEMNAME_MEAT, ITEMNAME_MONSTERMEAT,
	ITEMNAME_PICK, ITEMNAME_PIGTAIL, ITEMNAME_ROCK2, ITEMNAME_ROPE, ITEMNAME_WEB, ITEMNAME_TOARCH,ITEMNAME_END
};
