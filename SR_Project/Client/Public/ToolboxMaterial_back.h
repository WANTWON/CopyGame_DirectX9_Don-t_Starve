...
class CToolboxMaterial_back final : public CGameObject
{
private:
	CToolboxMaterial_back(LPDIRECT3DDEVICE9 pGraphic_Device);
	CToolboxMaterial_back(const CToolboxMaterial_back& rhs);
	virtual ~CToolboxMaterial_back() = default;
...
public:
	static CToolboxMaterial_back* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
