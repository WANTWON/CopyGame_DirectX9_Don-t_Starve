...
class CQuestpont final : public CGameObject
{
private:
	CQuestpont(LPDIRECT3DDEVICE9 pGraphic_Device);
	CQuestpont(const CQuestpont& rhs);
	virtual ~CQuestpont() = default;
...
public:
	static CQuestpont* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
