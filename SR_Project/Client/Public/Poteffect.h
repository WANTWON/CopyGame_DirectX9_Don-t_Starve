...
class CPoteffect final : public CGameObject
{
private:
	CPoteffect(LPDIRECT3DDEVICE9 pGraphic_Device);
	CPoteffect(const CPoteffect& rhs);
	virtual ~CPoteffect() = default;
...
public:
	static CPoteffect* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
