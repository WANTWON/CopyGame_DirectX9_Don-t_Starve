...
BEGIN(Client)
class CBoaron final : public CMonster
{
	enum STATE
	{
		IDLE,
...
private:
	CBoaron(LPDIRECT3DDEVICE9 pGraphic_Device);
	CBoaron(const CBoaron& rhs);
	virtual ~CBoaron() = default;
...
public:
	static CBoaron* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
