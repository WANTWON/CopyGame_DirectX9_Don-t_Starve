...
class CMiniMap_player final : public CGameObject
{
private:
	CMiniMap_player(LPDIRECT3DDEVICE9 pGraphic_Device);
	CMiniMap_player(const CMiniMap_player& rhs);
...
public:
	...
	static CMiniMap_player* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
